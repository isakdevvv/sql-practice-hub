...
// ---------------------------------------------------------------------------
// ANSLÅ-SÅ-SJEKK — fagnøytral gjett-før-avsløring.
//
...
//
// Komponenten er fagnøytral: `sporsmal` og `fasit` er ReactNode, så et anslag
// kan inneholde tabeller, kode, formler eller figurer. Den ble opprinnelig
// skrevet for TEK-1501 (statistikk) og lå under `stack/tek1-oppgaver/`, men
// brukes nå også av DTE-2505 og DTE-2507. `tek1-oppgaver/AnslaSaSjekk.tsx`
// re-eksporterer herfra med statistikk-spesifikk standard-intro, slik at de
// fire TEK-1501-modulene er uendret.
//
// Passer godt rett FØR en simulator: la studenten forplikte seg til et utfall,
// og la så simulatoren avgjøre. Uten det steget blir en simulator noe man ser
// på, ikke noe man lærer av.
// ---------------------------------------------------------------------------
      ...
      <div className="mb-4 rounded-lg border border-brand/30 bg-brand/5 p-4 text-sm">
        <div className="flex items-start gap-2">
          ...
          <div>
            {intro ?? (
              <>
                Gjett før du leser videre. Det er meningen at noen av disse skal overraske deg — det
                er nettopp der forventningen din brister at stoffet fester seg. Ingenting telles, og
