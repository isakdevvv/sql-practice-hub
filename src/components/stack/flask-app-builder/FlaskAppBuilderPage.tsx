...
export function FlaskAppBuilderPage() {
  ...
  return (
    <StackPageShell title="Flask App Builder" group="eksamen">
      <article className="container mx-auto px-4 py-10 max-w-6xl">
        <header className="mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">
            Flask App Builder — kryss av, få ferdig Flask + Bootstrap-kode
          </h1>
          <p className="mt-3 text-muted-foreground leading-relaxed">
            Velg byggesteinene du vil ha — sider, skjemaer, autentisering, database, Bootstrap-UI
            og JSON-API — så genereres en komplett, kjørbar Flask-app som bruker disse. Hver
            avhengighet løses automatisk: krysser du av <em>"Vis kundeliste"</em> aktiveres
            også <em>"SQLite-database"</em>.
          </p>
        </header>
            ...
            <details className="rounded-xl border border-border bg-card p-4">
              ...
              <div className="mt-3 text-sm space-y-3 text-muted-foreground">
                <p>
                  ...
                  <strong>app-config</strong>, <strong>helpers</strong>, <strong>routes</strong>{" "}
                  og <strong>templates</strong>. Builder-en samler bidragene, dedupliserer
                  imports, og setter alt sammen til én Flask-fil.
                </p>
                <p>
                  Templates som heter <code>base</code>, <code>navbar</code>, <code>flash</code>,{" "}
                  <code>footer</code> blir lastet inn i Jinjas <code>DictLoader</code>. Da kan
                  hver side bruke <code>{"{% extends \"base\" %}"}</code> for å arve layout.
                </p>
                <p>
                  Klikk <strong>"Kjør i Python-sandkasse"</strong> for å sende koden over til{" "}
                  <Link to="/python" className="text-brand hover:underline">/python</Link> der
                  Pyodide kjører den via Flask <code>test_client()</code>.
                </p>
              </div>
            </details>
          </div>
