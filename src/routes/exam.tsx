...
export const Route = createFileRoute("/exam")({
  head: () => ({
    meta: [
      { title: "Exam mode — SQL Sandbox" },
      { name: "description", content: "Timed mixed-difficulty SQL exam: 10 problems in 20 minutes." },
    ],
  }),
  component: ExamPage,
});
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-4 py-16 max-w-2xl text-center">
          <h1 className="text-3xl font-bold tracking-tight">Exam mode</h1>
