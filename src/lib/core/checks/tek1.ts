// Konsept-sjekker for TEK-1501 (sannsynlighet og statistikk).
//
// EIERSKAP: denne fila er statistikkfagets egen. Andre fag har sine egne
// filer i samme mappe, slik at flere kan skrive samtidig uten å kollidere.

import type { KonseptSjekkDef } from "./types";

export const TEK1_CHECKS: Record<string, KonseptSjekkDef[]> = {
  "tek1-sannsynlighet": [
    {
      id: "base-rate",
