...
export const FLASHCARDS: FlashCard[] = [
  ...
  // ============= DTE-2505: SCHEDULING (OSTEP kap. 7-10) =============
  {
    id: "c2505-sched-turnaround",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Formel for turnaround time?",
    answer: "T_turnaround = T_ferdig - T_ankomst. Total tid fra jobben kom inn til den er fullført. Snitt-turnaround er den klassiske metrikken for batch-scheduling — SJF/STCF minimerer denne.",
  },
  {
    id: "c2505-sched-response",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Forskjell på turnaround og response time?",
    answer: "Response = T_første_start - T_ankomst (hvor lenge før jobben i det hele tatt fikk CPU). Turnaround = T_ferdig - T_ankomst (total opphold). Round-robin gir lav respons, SJF/STCF gir lav turnaround — du må velge.",
  },
  {
    id: "c2505-sched-convoy",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hva er convoy effect i FIFO/FCFS?",
    answer: "Én lang jobb foran i køen blokkerer alle korte. Eks: jobb A burst 10, B og C burst 1 — alle ankommer på t=0. FIFO gir snitt-turnaround 10. SJF gir snitt 5. Klassisk argument for å bytte fra FIFO.",
  },
  {
    id: "c2505-sched-sjf-stcf",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Forskjell på SJF og STCF?",
    answer: "SJF (Shortest Job First) er ikke-preemptiv — velger kortest blant ankomne når CPU blir ledig, kjører jobben til ferdig. STCF (Shortest Time-to-Completion First) er preemptiv versjon: hver gang en ny jobb ankommer, bytt hvis den har kortere REMAINING tid. STCF er beviselig optimal for snitt-turnaround.",
  },
  {
    id: "c2505-sched-rr-kvantum",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hvordan velge tidskvantum i Round-Robin?",
    answer: "For lite → masse context-switch overhead (CPU bruker tid på å bytte i stedet for å regne). For stort → blir nesten FIFO og respons-tid lider. Typisk: 10-100 ms. Linux bruker dynamisk q basert på prioritet (~1-20 ms).",
  },
  {
    id: "c2505-sched-mlfq-regler",
    category: "praktisk",
    topic: "DTE-2505",
    question: "MLFQs hovedregel for prioritets-justering?",
    answer: "Hvis en jobb bruker hele kvantumet sitt → senk prioritet (CPU-tung). Gir den fra seg CPU før kvantum (I/O-blokk) → behold prioritet (interaktiv). Periodisk løft ALLE til topp (anti-starvation, OSTEPs regel R5).",
  },
  {
    id: "c2505-sched-mlfq-linux",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hvorfor MLFQ uten å vite burst-tid?",
    answer: "MLFQ LÆRER fra oppførsel. Korte interaktive jobber gir fra seg CPU mye → høy prioritet. Lange CPU-tunge bruker hele kvantum → synker. Du trenger ikke spå burst — scheduleren observerer. Prinsippet bak Linux CFS.",
  },
  {
    id: "c2505-sched-throughput",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hva er throughput, og hvordan regner du det?",
    answer: "Throughput = N / T_total — antall fullførte jobber delt på total tid. Måler hvor mange jobber systemet kan ekspedere per tidsenhet. Høy preemption + context-switch synker throughput; ren FIFO kan ha høyere throughput men dårlig respons.",
  },
  {
    id: "c2505-sched-starvation",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hvorfor kan ren SJF føre til starvation?",
    answer: "Hvis korte jobber stadig kommer inn, vil SJF alltid velge dem først. En lang jobb kan aldri komme til CPU-en. Fix: aging (la lange jobber bli prioritert med tida) eller periodisk priority-boost som i MLFQs regel R5.",
  },
  {
    id: "c2505-sched-fairness",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hva betyr 'fairness' i scheduling?",
    answer: "Hver jobb får en rimelig andel av CPU-en innen rimelig tid. Round-robin er fair (alle får q hver runde). SJF er ikke fair (lange jobber kan svelte). Linux CFS bruker virtual runtime for å gi proporsjonal fairness mellom prosesser.",
  },

  // ============= DTE-2505: VIRTUELT MINNE (OSTEP kap. 15-22) =============
  {
    id: "c2505-vm-vpn-pfn",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Forskjell på VPN og PFN?",
    answer: "VPN = Virtual Page Number, øvre del av virtuell adresse. PFN = Physical Frame Number, indeksen i fysisk RAM. Page-tabellen mapper VPN → PFN. Offset (nedre bits) er det samme i VA og PA.",
  },
  {
    id: "c2505-vm-formel",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hvordan bygges fysisk adresse fra VPN-oppslag?",
    answer: "PA = PFN * 2^(offset-bits) + offset. Eks: 16-bit VA, 4 KB pages (offset 12 bits). VA 0x2123: VPN=2, offset=0x123. Hvis PT[2]=PFN 7 → PA = 7*4096 + 0x123 = 0x7123. Bare VPN oversettes, offset er konstant.",
  },
  {
    id: "c2505-vm-tlb",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hva er TLB og hvorfor trenger vi den?",
    answer: "Translation Lookaside Buffer — en liten cache (64-1024 entries) i MMU-en som husker nylige (VPN→PFN). Uten den ville hver minneaksess kreve 4 ekstra minneaksesser på x86-64 (4-nivå page table). TLB-hit-rate >99% i godt skrevne programmer.",
  },
  {
    id: "c2505-vm-tlb-miss-vs-pf",
    category: "praktisk",
    topic: "DTE-2505",
    question: "TLB-miss = page fault?",
    answer: "Nei! TLB-miss betyr bare 'slå opp i page-tabellen i stedet'. Page fault skjer kun hvis PTE har valid=0 eller present=0 (siden finnes ikke i RAM). En TLB-miss er billig (få nanosekunder); en page fault til disk er millisekunder.",
  },
  {
    id: "c2505-vm-demand-paging",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hva er demand paging?",
    answer: "Sider lastes IKKE fra disk før prosessen faktisk treffer dem. Derfor er malloc(1 GB) momentant — du betaler først når du skriver til minnet. Også kjent som lazy loading av minnesider.",
  },
  {
    id: "c2505-vm-page-fault-typer",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Tre typer page fault?",
    answer: "1) Minor/soft: siden er i RAM, mangler bare i prosessens PT (delt bibliotek). Oppdater PTE. 2) Major/hard: siden er på disk (swap/mmap), les inn — millisekunder. 3) Invalid: ugyldig adresse → SIGSEGV (null-pointer, stack overflow).",
  },
  {
    id: "c2505-vm-belady-optimal",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hva er Beladys optimale replacement-algoritme?",
    answer: "Kast siden som blir brukt LENGST inn i fremtiden. Beviselig minimum antall page faults. Ikke implementérbar i praksis (krever spådom). Brukes som baseline for å måle andre algoritmer.",
  },
  {
    id: "c2505-vm-belady-anomali",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hva er Beladys anomali?",
    answer: "Med FIFO kan FLERE frames gi FLERE page faults i visse adresse-sekvenser — kontraintuitivt. LRU og Optimal kan ikke ha denne anomalien (de er 'stack algorithms'). Sterk grunn til å foretrekke LRU/Clock fremfor FIFO.",
  },
  {
    id: "c2505-vm-clock",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hvordan virker Clock (second-chance) replacement?",
    answer: "Sirkulær liste over frames + reference-bit per side. Pekeren går rundt: hvis bit=1, sett til 0 og gå videre. Hvis bit=0, kast siden og bruk frame-en. Tilnærmer LRU billig — brukes (med varianter) i Linux page reclaim.",
  },
  {
    id: "c2505-vm-thrashing",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hva er thrashing?",
    answer: "Når summen av alle prosessers working sets > RAM. Systemet bruker mer tid på å lese/skrive sider mellom disk og RAM enn på å regne. CPU mot 0%, disk på 100%. Eneste utvei: drep en prosess (OOM-killer) eller swap inn mer RAM.",
  },

  // ============= DTE-2505: CONCURRENCY (OSTEP kap. 28-33) =============
  {
    id: "c2505-conc-race",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hva er en race condition?",
    answer: "Utfallet av et program avhenger av rekkefølgen tråder skedulleres i. Klassisk: to tråder gjør `counter += 1` parallelt. Som maskinkode er det load+add+store; hvis OS bytter mellom load og store, går telleren bare opp med 1 i stedet for 2.",
  },
  {
    id: "c2505-conc-mutex-vs-semafor",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Forskjell på mutex og semafor?",
    answer: "Mutex har EIER: bare tråden som låste kan låse opp. Semafor har en TELLER, ingen eier — hvem som helst kan post(). Binær semafor (telle 0/1) ligner mutex, men uten eierskaps-håndhevelse → lettere å bruke feil.",
  },
  {
    id: "c2505-conc-cv-while",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hvorfor `while` og ikke `if` rundt cond.wait()?",
    answer: "Spurious wakeups: tråden kan våkne uten at signal() ble kalt. Også: hvis flere consumers, kan en annen ha stjålet elementet før du våknet. Loop og sjekk betingelsen på nytt etter hvert wakeup.",
  },
  {
    id: "c2505-conc-coffman-4",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Coffmans fire betingelser for deadlock?",
    answer: "1) Mutual exclusion (ressurser delbar bare av én). 2) Hold and wait (holder en, venter på en annen). 3) No preemption (kan ikke ta tilbake lås). 4) Circular wait (sirkel i ventegraf). ALLE fire må være sanne samtidig. Bryt én → ingen deadlock.",
  },
  {
    id: "c2505-conc-circular-wait-fix",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hvordan bryte circular wait i praksis?",
    answer: "Pålegg total orden på låser. Gi hver lås et ID-nummer. Krev at all kode tar låser i strengt stigende rekkefølge. Da kan det matematisk ikke oppstå en sirkel — alle tråder konkurrerer alltid om låser i samme rekkefølge.",
  },
  {
    id: "c2505-conc-deadlock-vs-race",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Race condition vs. deadlock — forskjell?",
    answer: "Race = utfallet er ikke-deterministisk fordi tråder kjører i ukjent rekkefølge. Deadlock = ingen tråder gjør fremgang fordi de venter på hverandres låser. Du kan ha race uten deadlock (inkonsistente verdier), og du kan ha deadlock uten race (bare hengt).",
  },
  {
    id: "c2505-conc-rag",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hva er en ressurs-allokeringsgraf (RAG)?",
    answer: "Graf med prosesser (sirkler) og ressurser (firkanter). Kant R→P = 'R holdes av P'. Kant P→R = 'P ber om R'. Med én instans per ressurs: SIRKEL i grafen = deadlock. Med flere instanser kreves detaljert sjekk (Banker's algorithm).",
  },
  {
    id: "c2505-conc-dining-phil",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hvordan løses dining philosophers uten deadlock?",
    answer: "Bryt symmetri = bryt circular wait. Enkleste fix: én filosof tar høyre gaffel først (de andre venstre først). Da kan ingen sirkel oppstå. Andre løsninger: semafor som begrenser antall samtidig sittende (n-1), eller bestiller låser etter ID.",
  },
  {
    id: "c2505-conc-livelock",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Forskjell på livelock og deadlock?",
    answer: "Deadlock: tråder hengt, gjør INGENTING. Livelock: tråder kjører aktivt, men kommer ingen vei — de bare reagerer på hverandre (to høflige folk i en dør som hele tida flytter seg for hverandre). Begge blokkerer fremgang; livelock er vanskeligere å oppdage.",
  },
  {
    id: "c2505-conc-gil",
    category: "praktisk",
    topic: "DTE-2505",
    question: "Hvorfor trengs låser i Python selv med GIL?",
    answer: "GIL serialiserer Python-bytekode, men `counter += 1` består av FLERE bytekoder (LOAD, ADD, STORE). GIL kan slippes mellom dem. Resultat: race condition også med GIL. Bruk threading.Lock for delt mutable state. CPU-bundne ting: bruk multiprocessing for å unngå GIL.",
  },
