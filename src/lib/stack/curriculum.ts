...
export const PHASES: readonly CurriculumPhase[] = [
  {
    ...
    why: "Prerekvisitt for ML og algoritmer. Diskret matte for CS, sannsynlighet for ML, linær algebra for nevrale nett og PCA.",
  ...
  },
  {
    ...
    why: "TEK-1501 sitt eget løp, skilt fra diskret matte og linær algebra som hører til andre fag. Bygger fra beskrivende tall → sannsynlighet → fordelinger → CLT → inferens → tester: du kan ikke tolke et konfidensintervall før du vet hva en samplingfordeling er.",
    analog: "Stanford CS 109 · MIT 18.05 · Penn State STAT 500",
    dependsOn: [],
    layer: "matematikk",
    ...
    slugs: [
      ...
      // Utvidelser som forutsetter hele inferens-maskineriet
      "tek1-proporsjoner",
      "tek1-anova",
      "tek1-regresjon-diagnostikk",
    ],
  },
  {
    num: 1,
    ...
    why: "Før noe annet: bygg opp en datamaskin fra transistorer. Du kan ikke forstå performance, OS eller minne uten å vite hva som faktisk skjer under abstraksjonene.",
    analog: "MIT 6.004 · CMU 15-213 · ETH Digital Design",
    dependsOn: [],
    layer: "hardware",
    shortSummary: "Transistor → NAND → adder → CPU → assembly → C → bytes",
    slugs: [
      "trinn-0-signals-codes",
      "trinn-1-transistor",
      "trinn-2-nand-porter",
      "trinn-3-adders",
      "trinn-4-cpu",
  ...
  },
  {
    ...
    why: "Når du kan kjøre kode, MÅ du vite hvordan den skalerer. Big-O er språket alt annet bruker. Datastrukturer er byggesteinene for både OS, DB og ML.",
  ...
  },
  {
    ...
    why: "Før du skalerer kode, lær prinsipper som gjør den robust: pure functions, immutability, sum types, generics. Disse er grunnlaget for moderne språk og bibliotek.",
  ...
  },
  {
    ...
    why: "OS er det første store steget i abstraksjon over hardware. Du må kunne prosesser, minne, filsystem og syscalls før du kan resonnere om performance eller sikkerhet.",
    ...
    slugs: [
      ...
      "dte2505-thread-state",
      "dte2505-kontekstbytte",
      "dte2505-scheduling-drill",
      "dte2505-konkurrens",
      "deadlock-viz",
      ...
      "dte2505-ipc",
      "dte2505-event-loop",
      "dte2505-segmentation",
      "dte2505-virtuelt-minne",
  ...
  },
  {
    ...
    why: "OS lar én maskin gjøre noe. Nettverk lar flere snakke sammen. Kryptografi sikrer at de snakker uten avlytting. Hele moderne software bygger på dette.",
  ...
  },
  {
    ...
    id: "database",
    title: "Databaser",
    why: "Persistent state er der applikasjoner faktisk lever. Relasjonsmodellen + SQL er den varigste abstraksjonen i hele faget — over 50 år og fremdeles dominerende.",
  ...
  },
  {
    ...
    why: "Web er hvor alt møtes: nettverk + OS + DB + UI. HTTP er den vanligste protokollen for å lage produkter. Lær request-flyten før du legger på frameworks.",
  ...
  },
  {
    ...
    why: "Før nevrale nett kom intelligensen fra eksplisitt søk og logikk. R&N-pensum er fortsatt fundamentet. Mange «moderne» AI-løsninger er fremdeles søk eller CSP.",
    ...
    slugs: [
      ...
      "planlegging",
      "bayes",
      "dte2501-td-qlearning",
      "dte2501-mcts",
      "dte2501-hmm-particle",
      "ai-etikk",
    ],
  },
  {
    ...
    id: "ml",
    title: "Maskinlæring",
    why: "ML er funksjonstilnærming fra data. Krever statistikk-grunnlag (forventes prerekvisitt) + algoritmer. Lær rammeverket FØR du henter dype nett.",
  ...
  },
  {
    ...
    id: "deep-learning",
    title: "Deep learning",
    why: "Konvolusjon, backprop dypt, regularisering, optimere. Bygger på ML-grunnlaget men krever vesentlig matematisk modenhet.",
  ...
  },
  {
    ...
    why: "Kode alene er ikke produkt. Smidig metodikk, krav, UML og prosjekt-praksis er det som skiller en jr.dev fra noen som kan levere. Industri-fokusert.",
    analog: "MIT 6.170/6.171 · Stanford CS 194 · CMU 17-313",
    dependsOn: ["web"],
    layer: "produkt",
    shortSummary: "Smidig, brukerhistorier, UML, prosjekt-praksis",
    slugs: ["dte-2604", "su-metodikker", "brukerhistorier", "uml", "su-prosjekt-praksis"],
  },
  {
    num: 11,
    id: "api-prosjekt",
    title: "API-prosjekt fra A til Å — produksjon",
    why: "Spesialisering: hvordan bygge og deploye et komplett API. Arkitektur, kontrakt, testing, observability, CI/CD. Industriens beste praksis i ett kurs.",
  ...
  },
  {
    ...
    why: "Git-dyp, Docker, og avansert Linux-CLI er fundamentet for moderne deploy- og samarbeids-flyt. Disse verktøyene brukes i ALLE jobber.",
  ...
  },
  {
    ...
    why: "Spor for de som vil lage mobile apper. Bygger på OS + algoritmer + nettverk + DB. Kotlin er moderne JVM-språk; Android er Linux-OS-en på telefon.",
  ...
  },
  {
    ...
    why: "Spor for de som vil bygge bedriftssystemer. Microsoft-stacken er dominerende i finans, helse og offentlig sektor. ASP.NET + EF + Blazor.",
    analog: "Industri-fokusert (Microsoft-stack)",
    dependsOn: ["web", "database"],
    layer: "spesialisering",
    shortSummary: "C#, ASP.NET MVC/API, EF Core, Blazor",
    slugs: ["dte-2802", "csharp-grunnlag", "aspnet-mvc", "aspnet-webapi", "ef-core", "blazor"],
  },
  {
    num: 14,
    id: "drill",
    title: "Eksamens-drill & repetisjon",
    why: "Når du har gått gjennom hele løypa: drill det viktigste til det sitter. Spaced repetition og hands-on eksamens-trening.",
    dependsOn: [],
    layer: "produkt",
...
const ORDER_INDEX = new Map<string, number>(CURRICULUM_ORDER.map((slug, i) => [slug, i]));
